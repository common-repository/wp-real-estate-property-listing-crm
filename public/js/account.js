		...
		return {
			init:function(){
				$(document).on('submit','.profile-form',function(e){
					...
					var lang_account_msg_update = MDAjax.lang_account_msg_update;
					var lang_account_msg_update_pw = MDAjax.lang_account_msg_update_pw;
					...
					html_msg.html('<p>' + lang_account_msg_update + '</p>');
		...
		return {
			init:function(){
				$(document).on('submit','.password-form',function(e){
					...
					html_msg.html('<p>' + lang_account_msg_update_pw + '</p>');
