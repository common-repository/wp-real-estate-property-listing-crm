...
<?php md_search_form_start(); ?>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-md-8 no-padding-right-col">
			...
			<div class="form-group">
				<button class="btn btn-more-search-option mwp-theme-bk-color" aria-label="Left Align" type="button" data-toggle="collapse" data-target="#more-search-options" aria-expanded="false" aria-controls="more-search-options">
	...
	<div class="collapse" id="more-search-options">
		...
		<?php if( mwp_get_current_api_source() == 'crm' ){ ?>
			<div class="md-divider"></div>
			<div class="row md-container">
				<div class="col-md-3 col-xs-12 no-padding-right-col hidden">
