...
<?php foreach($properties_key as $key => $val_source){ ?>
	<?php if( isset($xout_properties[$val_source]) && $xout_properties[$val_source]->loop_property() ): ?>
		<div class="mwp-bootstrap">
			<div id="md-listing-results">
				<div class="row">
				<?php while($xout_properties[$val_source]->loop_property()): $xout_properties[$val_source]->md_set_property();mwp_set_loop($xout_properties[$val_source]); ?>
