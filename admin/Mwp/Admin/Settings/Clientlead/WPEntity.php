 ...
 * Popup Model
 * */
class Mwp_Admin_Settings_Clientlead_WPEntity {
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-settings-client-lead';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Client Lead';
	protected $admin_menu_title = 'Client Lead';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_Settings_Clientlead::get_instance(), 'controller')
		);
	}
