 ...
 * Popup Model
 * */
class Mwp_Admin_Settings_Mail_WPEntity {
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-settings-mail';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Mail';
	protected $admin_menu_title = 'Mail';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_Settings_Mail::get_instance(), 'controller')
		);
	}

	public function __construct(){
		$this->model_mail = new Mwp_Settings_Mail_Model;
		$this->entity_mail = new Mwp_Settings_Mail_Entity;
	}
