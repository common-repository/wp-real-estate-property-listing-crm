 ...
 * Setup CRM Key
 * */
class Mwp_Admin_Propertyalert_WPEntity{
	protected static $instance = null;
	protected $admin_menu_slug = 'md-property-alert';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Property Alert';
	protected $admin_menu_title = 'Property Alert';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_Propertyalert_Settings::get_instance(), 'controller')
		);
	}
