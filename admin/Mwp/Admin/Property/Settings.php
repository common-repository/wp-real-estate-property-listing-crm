 ...
 * Setup CRM Key
 * */
class Mwp_Admin_Property_Settings{
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-settings-property';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Property Settings';
	protected $admin_menu_title = 'Property Settings';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_Property_Settings::get_instance(), 'controller')
		);
	}
