 ...
 * Setup CRM Key
 * */
class Mwp_Admin_Search_WPEntity{
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-settings-search';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Search Form / Related Settings';
	protected $admin_menu_title = 'Search Form / Related Settings';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_Search_Settings::get_instance(), 'controller')
		);
	}
