 ...
 * Setup CRM Key
 * */
class Mwp_Admin_API_Social_WPEntity{
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-social-api';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Social API';
	protected $admin_menu_title = 'Social API';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_API_Settings::get_instance(), 'controller')
		);
	}
