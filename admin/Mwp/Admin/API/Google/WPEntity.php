 ...
 * Setup CRM Key
 * */
class Mwp_Admin_API_Google_WPEntity{
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-google-api';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Google API';
	protected $admin_menu_title = 'Google API';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_API_Google::get_instance(), 'controller')
		);
	}
