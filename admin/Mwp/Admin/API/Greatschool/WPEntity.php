 ...
 * Setup CRM Key
 * */
class Mwp_Admin_API_Greatschool_WPEntity{
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-greatschool-api';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Greatschool API';
	protected $admin_menu_title = 'Greatschool API';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_API_Greatschool::get_instance(), 'controller')
		);
	}
