 ...
 * Setup CRM Key
 * */
class Mwp_Admin_API_WPEntity{
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-settings-api';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'API Settings';
	protected $admin_menu_title = 'API Settings';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			Mwp_Admin_API_Social_WPEntity::get_instance()->get_admin_menu_slug(),
			array(Mwp_Controllers_API_Social::get_instance(), 'controller')
		);
	}
