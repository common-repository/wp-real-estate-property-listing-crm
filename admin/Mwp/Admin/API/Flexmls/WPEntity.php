 ...
 * Setup CRM Key
 * */
class Mwp_Admin_API_Flexmls_WPEntity{
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-flexmls-api';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Flex MLS';
	protected $admin_menu_title = 'Flex MLS';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_API_Flexmls::get_instance(), 'controller')
		);
	}
