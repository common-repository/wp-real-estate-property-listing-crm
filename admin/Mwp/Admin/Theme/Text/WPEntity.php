 ...
 * Setup CRM Key
 * */
class Mwp_Admin_Theme_Text_WPEntity{
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-settings-theme-text';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Text';
	protected $admin_menu_title = 'Text';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_Theme_Text::get_instance(), 'controller')
		);
	}
