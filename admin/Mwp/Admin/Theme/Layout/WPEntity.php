 ...
 * Setup CRM Key
 * */
class Mwp_Admin_Theme_Layout_WPEntity{
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-settings-theme-layout';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Layout';
	protected $admin_menu_title = 'Layout';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_Theme_Layout::get_instance(), 'controller')
		);
	}
