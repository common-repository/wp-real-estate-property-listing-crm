 ...
 * Setup CRM Key
 * */
class Mwp_Admin_Theme_Settings{
	...
	public function tab_nav(){
		...
		$data['tab_nav_template'] = 'theme/tab-nav.php';
	...
	public function __construct(){
		$this->theme_admin_wpentity = new Mwp_Admin_Theme_WPEntity;
		$this->theme_admin_property_wpentity = new Mwp_Admin_Theme_Property_WPEntity;
	}
}
