 ...
 * Setup CRM Key
 * */
class Mwp_Admin_Theme_Property_WPEntity{
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-settings-theme-property';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Property';
	protected $admin_menu_title = 'Property';
