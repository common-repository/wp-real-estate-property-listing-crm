 ...
 * Setup CRM Key
 * */
class Mwp_Admin_Theme_Map_WPEntity{
	protected static $instance = null;
	protected $admin_parent_menu = 'options.php';
	protected $admin_menu_slug = 'md-settings-theme-map';
	protected $admin_url_slug = 'admin.php?page=';
	protected $admin_menu_page_title = 'Map Settings';
	protected $admin_menu_title = 'Map Settings';
	...
	public function add_submenu_page(){
		add_submenu_page(
			...
			array(Mwp_Controllers_Theme_Map::get_instance(), 'controller')
		);
	}
