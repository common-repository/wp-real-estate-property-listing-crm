		...
		<div class="col-md-6 col-xs-12">
			<p>
				...
				<select name="transaction" id="transaction">
					<option value="sale"><?php _e('For Sale', mwp_localize_domain());?></option>
				</select>
			</p>
			...
			<p><?php _e('Include Office List?', mwp_localize_domain());?> <input type="checkbox" name="listing_office_id" id="listing_office_id"></p>
		</div>
	</div>
	<p></p>
...
<script>
	//var mls_jquery_auto_location = <?php echo $obj_this->get_location(); ?>;
