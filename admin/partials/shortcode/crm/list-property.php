		...
		<div class="col-md-6 col-xs-12">
			<p>
				...
				<select name="transaction" id="transaction">
					<?php foreach(mwp_get_property_transaction_type() as $k => $v){ ?>
						<option value="<?php echo $v;?>"><?php _e($v, mwp_localize_domain());?></option>
					<?php } ?>
				</select>
			</p>
...
<script>
	...
	$('#insert-shortcode', context).on('click',function(e){
		...
		state_shortcode = ' stateid="'+state_id.replace(/,+$/,'')+'" ';
