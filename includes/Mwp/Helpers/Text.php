...
class Mwp_Helpers_Text {
	...
	public static function array_to_object($array, $assoc = FALSE){
		return json_decode(json_encode($array), $assoc);
	}

	public static function obj_array_values($array, $assoc = true){
		return array_values(self::array_to_object($array, $assoc));
	}
