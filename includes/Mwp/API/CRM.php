...
protected $endPoint;
    ...
    /**
     * Saves a property alert request
     * $data values :
     * account_id int //
     * leadid int
     * lead_email
     ...
     * mls
     * city
     * transaction_type - 'sale' , 'rent', 'foreclosure'
     *
     * @param array $data
     * @return string json decoded string
     */

    public function savePropertyAlert( $data )
    {
        return $this->sendRequest( 'alerts/savealert' , $data );
    }
    ...
    public function getFeaturedProperties( $user_id , $options = array() )
    {
    ...
    {   
        ...
        mwp_end_execution_time($uri.'?'.$data);
        return $decode;
    }
}
