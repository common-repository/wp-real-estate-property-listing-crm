...
class Mwp_API_Facebook{
	...
	private function lead_push_crm($lead_data = array()){
		...
		$save_lead = Mwp_CRM_AccountDetails::get_instance()->push_crm_data($_POST);
	...
	public function js_init(){
		...
		<script>
			...
			window.fbAsyncInit = function() {
				FB.init({
					appId      : '<?php echo Mwp_API_Social_Model::get_instance()->masterdigm_facebook_id('r');?>',
					cookie     : true,  // enable cookies to allow the server to access
										// the session
					xfbml      : true,  // parse social plugins on this page
					version    : '<?php echo Mwp_API_Social_Model::get_instance()->masterdigm_facebook_version('r');?>'
				});
	...
	public function login_button(){
		if( Mwp_API_Social_Model::get_instance()->masterdigm_facebook_id('r') ){
			$this->js_init();
			$template = Mwp_Theme_Locator::get_instance()->locate_template('facebookapp/login-button.php');
			$data = array();
